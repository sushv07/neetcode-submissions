...
class Solution:
    def reverseKGroup(self, head: Optional[ListNode], k: int) -> Optional[ListNode]:
        ...
        while True:
            ...
            #1 -> 2 - > 3
            #prev = 4 / curr = 1
            # curr = the first node of the group I’m reversing.
            # prev = the node that should come after the reversed group 
            # (the first node of the next group, or None if this is the last group).
